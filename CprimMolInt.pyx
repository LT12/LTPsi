...
cdef double primOverlapIntegral(double x1,double y1,double z1,double x2,double y2,double z2,
    ...
    """Calculates the overlap integral for primitive Gaussian-type orbitals.
        ...
        Keyword arguments:
        x1 -- the Cartesian coordinates of orbital 1
        x2 -- the Cartesian coordinates of orbital 2
        a1 -- Gaussian exponential coefficient for orbital 1
        a2 - -Gaussian exponential coefficient for orbital 1
        xnum1 ,ynum1 ,znum1 -- angular "quantum numbers" for the orbitals
    """
...
cdef double OL_Sab_terms(int q1,int q2,double a12,double AB,double PA)nogil:
    '''Obara - Saika Recurrense relation to obtain angular overlap term
       ...
       Keyword arguments:
       q1, q2 - angular number for orbitals 1 and 2
       a12 - reduced sum of coefficient for orbitals 1 and 2
       AB - distance in specific direction between orbitals
       PA - distance of orbital 1 from weighted center
        
       Return:
       Sab - S(a,b), the angular overlap term from OS recurrence
    '''
    #Base cases
    if q1 + q2 == 0: return 1
...
cdef double primNuclearAttractionIntegral(double XN,double YN,double ZN,double X1,double Y1,
    ...
    ''' computes nuclear attraction integral for 2 primitive GTOs <2|1/r|1>
        ...
        Arguments:
        ----------------------
        XN - Coordinates of nucleus
        X1 - Coordinates of orbital 1
        X2 - Coordinates of orbital 2
        x1 - angular quant number for orb. 1
...
cdef double ChebGausInt(double eps,int M,double a12,double a34,int qx1,int qx2,int qx3,int qx4,
                        ...
                        double z1, double z2, double z3,double z4, double Px,double Py,double Pz,
                        double Qx,double Qy,double Qz,double T)nogil:
